...
<head>
    ...
    <title>Tambah Guru - Rainbow Edu</title>
...
<body>
    <div class="wrapper">
        ...
        <div class="main-content">
            ...
            <div class="card">
                <form action="{{ route('admin.users.guru.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="guru_type" name="guru_type" class="form-control" required>
                                ...
                                <option value="Homelearning kursus private" {{ old('guru_type') == 'Homelearning kursus private' ? 'selected' : '' }}>Home Learning</option>
                            </select>
                            @error('guru_type')
                                <p style="color: #e53e3e; font-size: 13px; margin-top: 5px;">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <p style="color: #718096; font-size: 13px; margin-top: 5px;">
                            ⚠️ Kosongkan jika ingin password digenerate otomatis
                        </p>
                    </div>
                    ...
                    <div style="background: #ebf8ff; border-left: 4px solid #4299e1; padding: 16px; margin-bottom: 25px; border-radius: 8px;">
                        <p style="color: #2c5282; font-size: 14px;">
                            ...
                            - Guru akan otomatis terverifikasi<br>
                            - Email harus unik dan belum terdaftar<br>
                            - Password akan ditampilkan sekali setelah submit
                        </p>
                    </div>
